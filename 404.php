...
<head>
    ...
    <style type="text/css">
        ...
        body {background:url('<?php echo get_template_directory_uri(); ?>/images/404.png') center no-repeat #262626}
        ...
        @media only screen and (max-width: 460px), screen and (max-height: 400px) {
